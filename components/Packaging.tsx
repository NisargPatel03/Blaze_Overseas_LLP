    ...
    return (
        ...
        >
            <div className="max-w-[1400px] mx-auto text-center mb-16 relative">
                ...
                <h2 className="pack-header text-4xl md:text-5xl lg:text-6xl font-display font-medium max-w-4xl mx-auto text-balance mb-8">
                    Packaging & Delivery
                </h2>
                <p className="pack-header text-lg md:text-xl max-w-3xl mx-auto text-foreground/70 leading-relaxed">
            ...
            <div className="pack-grid grid grid-cols-1 md:grid-cols-3 gap-8 max-w-[1200px] mx-auto">
                 <div className="pack-card bg-neutral-50 dark:bg-[#111] p-10 rounded-sm border border-black/5 dark:border-white/5 flex flex-col items-center text-center group transition-colors hover:border-[var(--color-accent)]">
                    <div className="w-16 h-16 bg-white dark:bg-[#1a1a1a] rounded-full flex items-center justify-center mb-6 shadow-sm group-hover:scale-110 transition-transform duration-500">
                        <PackageOpen className="text-[var(--color-accent)]" size={30} />
                    </div>
                    <h3 className="text-2xl font-display font-medium mb-4">Export Grade Packaging</h3>
                ...
                <div className="pack-card bg-neutral-50 dark:bg-[#111] p-10 rounded-sm border border-black/5 dark:border-white/5 flex flex-col items-center text-center group transition-colors hover:border-[var(--color-accent)]">
                    ...
                    <h3 className="text-2xl font-display font-medium mb-4">Timely Delivery</h3>
                    <p className="text-foreground/70 leading-relaxed">
                ...
                <div className="pack-card bg-neutral-50 dark:bg-[#111] p-10 rounded-sm border border-black/5 dark:border-white/5 flex flex-col items-center text-center group transition-colors hover:border-[var(--color-accent)]">
                    ...
                    <h3 className="text-2xl font-display font-medium mb-4">Custom Solutions</h3>
                    <p className="text-foreground/70 leading-relaxed">
