    ...
    <main className="w-full bg-[#050505] min-h-screen text-white font-sans selection:bg-[#F5A623] selection:text-black">
      <div className="w-full max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-[1.618fr_1fr] relative">
        ...
        <section className="relative w-full h-[60vh] lg:h-screen lg:sticky top-0 bg-[#060606] flex flex-col items-center justify-center overflow-hidden border-b lg:border-b-0 lg:border-r border-[#F5A623]/10">
          ...
          <div className="absolute inset-0 z-[3] pointer-events-none" style={{ background: 'linear-gradient(135deg, rgba(5,5,5,0.0) 0%, rgba(5,5,5,0.3) 40%, rgba(5,5,5,0.75) 70%, rgba(5,5,5,0.95) 100%)' }} />

          <div className="absolute top-24 left-6 md:left-12 md:top-28 z-[4] text-[11px] text-white/60 uppercase tracking-widest bg-black/40 backdrop-blur-md px-4 py-2 rounded-full border border-white/10 hidden sm:block">
                ...
                <button suppressHydrationWarning
                  ...
                  className={`px-5 py-2 text-[12px] font-medium rounded-lg transition-all duration-300 shadow-sm ${
                    activeSize === size.label 
                      ...
                      : "bg-transparent border border-transparent text-white/70 hover:text-white hover:bg-white/10 hover:border-white/10"
                  }`}
                >
                  {size.label}
                </button>
        ...
        <section className="px-6 py-12 lg:p-12 xl:p-16 lg:pt-32 relative bg-[#050505]">
          <div className="max-w-[600px] mx-auto lg:mx-0 flex flex-col items-start gap-6">
            ...
            <div className="text-[15px] leading-[1.8] text-white/65 animate-[fadeSlideUp_0.5s_ease-out_0.6s_both]">
              {product.description}
            </div>
        ...
        <div className="max-w-[1000px] mx-auto">
          ...
          <div className="w-full overflow-x-auto rounded-xl border border-[#F5A623]/20">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="text-[14px] text-white/80">
                <tr className="bg-[#050505] border-b border-[#F5A623]/10">
                  <td className="px-6 py-4 border-r border-[#F5A623]/10 font-medium">Shelf Life</td>
                  <td className="px-6 py-4">{product.shelfLife}</td>
                </tr>
                <tr className="bg-[#080400] border-b border-[#F5A623]/10">
      ...
      <section id="inquiry-form" className="w-full bg-[#060400] py-24 px-6 relative">
      ...
      <section className="w-full py-20 px-6 bg-[#050505]">
        <div className="max-w-[1240px] mx-auto">
          <h3 className="text-xl font-display font-medium text-white mb-8 border-b border-[#F5A623]/20 pb-4 inline-block">You may also be interested in</h3>
          ...
          <div className="flex overflow-x-auto pb-8 gap-4 snap-x hide-scrollbar" style={{ scrollbarWidth: 'none' }}>
            {relatedProducts.map(rel => (
              <Link key={rel.id} href={`/products/${rel.categorySlug}/${rel.slug}`} className="snap-start shrink-0">
                <TiltCard className="w-[200px] h-[140px] border border-[#F5A623]/10 rounded-xl overflow-hidden group bg-[#080400]">
